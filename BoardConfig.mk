...
# SHRP Flags
SHRP_PATH := device/xiaomi/blossom
SHRP_MAINTAINER := Beginner_Dev
SHRP_DEVICE_CODE := blossom
SHRP_EDL_MODE := 1
SHRP_EXTERNAL := /external_sd
SHRP_INTERNAL := /data
SHRP_OTG := /usb_otg
# MediaTek Partition Paths
BOARD_RECOVERY_PARTITION_SIZE := 67108864
TARGET_RECOVERY_DEVICE_MODULES += libion
TARGET_RECOVERY_FSTAB := $(DEVICE_PATH)/recovery/recovery.fstab
TW_USE_FSCRYPT_POLICY := 2
BOARD_ROOT_EXTRA_FOLDERS += metadata
TARGET_SUPPORTS_64_BIT_APPS := true
TW_RECOVERY_ADDITIONAL_RESCUE_RAMDISK_FILES += \
...
# --- FBE MTK FIX ---
TW_USE_EXTERNAL_FSCRYPT := true
# TW_INCLUDE_FBE_METADATA_DECRYPT disabled
BOARD_USES_METADATA_PARTITION := true
TARGET_RECOVERY_DEVICE_MODULES += libfscrypttwrp
